        ...
        <div class="grid w-full sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="relative flex flex-col shadow-md rounded-xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 max-w-sm">
                ...
                <span data-modal-target="crud-modal" data-modal-toggle="crud-modal">
                        ...
                        <a id="add-button" href="{{route('categories.edit', $cate)}}" class="text-blue-500 hover:text-blue-700">Edit</a>
                        </span>
...
<div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ route('categories.update', $cate) }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                @csrf
                @method('put')
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="nomCategorie" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                    ...
                    <div class="col-span-2">
                        ...
                        <input id="picture" name="picture" type="file" class="hidden">
                        <label for="picture" class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center">
                ...
                <input type="submit" value="Update Category" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            </form>
        </div>
    </div>
</div>
